...
(b("#netWarn").length || (b(".main-search").prepend('<p id="netWarn">' + window.checknet.config.warnMsg + "</p>"), b("#netWarn").fadeIn("fast")), b('button[type="submit"]').attr("disabled", "disabled").addClass("tempDisabled"), b('#search-results').addClass("disable-links"))
