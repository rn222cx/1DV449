...
(b("#netWarn").length || (b(".body-content").prepend('<p id="netWarn">' + window.checknet.config.warnMsg + "</p>"), b("#netWarn").fadeIn("fast")), b('button[type="submit"]').attr("disabled", "disabled").addClass("tempDisabled"), b('#search-results').addClass("disable-links"), b("#local-cache").removeClass("show-cache"))
